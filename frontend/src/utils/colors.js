 ...
 */
export function getColorBySign(value, maxAbs) {
 ...
 */
export function getColorMono(value, maxAbs, color) {
 ...
 */
export function getColorCentered(value) {
 ...
 */
export function getColorCrowded(crowdedObj) {
