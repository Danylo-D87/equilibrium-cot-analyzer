            ...
            <div className="relative max-w-4xl w-full mx-4">
                ...
                <div ref={cardRef} className="bg-[#111111] border border-white/[0.06] rounded-[20px] overflow-hidden relative">
                    ...
                    <div className="relative p-16 min-h-[400px] flex flex-col justify-between">
                        ...
                        <div className="flex flex-col items-center justify-center flex-1 py-16">
                            ...
                            {_subtitle && (
                                <div className="mt-8 text-[10px] font-sans tracking-[0.2em] text-white/30 uppercase text-center">
                                    {_subtitle}
                                </div>
                            )}
                        </div>
                ...
                <div className="mt-6 flex justify-center">
                    <button onClick={handleCopyImage} disabled={copying} className="flex items-center justify-center gap-2.5 px-8 py-3 text-[9px] font-medium uppercase tracking-[0.22em] transition-all duration-300 border rounded-full outline-none focus:outline-none bg-white text-black hover:bg-white/90 disabled:opacity-40">
                        {copied ? <><Check size={14} strokeWidth={1.5} /><span>Image copied!</span></> : copying ? <><div className="animate-spin rounded-full h-3.5 w-3.5 border-b border-white/50" /><span>Creating...</span></> : <><Copy size={14} strokeWidth={1.5} /><span>Copy card</span></>}
                    </button>
                </div>
            </div>
        </div>
