...
export interface CotSignal {
    ...
    desc: string;
    color: string;
    group: 'bullish' | 'bearish' | 'exhaustion';
}

export const COT_SIGNALS: readonly CotSignal[] = [
    // Bullish
 ...
 */
export function detectCotSignal(priceUp: boolean, longsUp: boolean, shortsUp: boolean): string {
